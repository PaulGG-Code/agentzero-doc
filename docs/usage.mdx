---
title: 'Usage Guide'
description: 'A guide to exploring usage and configuration scenarios for Agent Zero.'
date: 2024-07-25
---
...
* **Import Knowledge:** Import external files into the agent's knowledge base
  ...
  - See [knowledge](/docs/architecture#knowledge) for more details
...
## Tool Usage
Agent Zero's power comes from its ability to use [tools](/docs/architecture#tools). Here's how to leverage them effectively:
...
* **Hierarchy:** Agent Zero uses a [hierarchical structure](/docs/architecture#agent-hierarchy-and-communication), with superior agents delegating tasks to subordinates.  This allows for structured problem-solving and efficient resource allocation.
