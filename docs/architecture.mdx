---
title: 'Architecture'
description: "A high-level overview of Agent Zero's architecture."
date: 2024-07-25
---
...
page. See [Full Binaries Installation](/docs/installation#in-depth-guide-for-full-binaries-installation) 
...
See [Contributing](/docs/contribution) for more information.
</Note> 