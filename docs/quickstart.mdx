---
title: 'Quick Start'
description: 'A quick introduction to using Agent Zero.'
date: 2024-07-25
---
...
1. Make sure you have Agent Zero installed and your environment set up correctly (refer to the [Installation guide](/docs/installation) if needed).
...
<Note type="tip">
The [Usage Guide](/docs/usage) provides more in-depth information on using Agent 
