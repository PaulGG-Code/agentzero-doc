...
description: 'User installation guide for Windows, macOS and Linux.'
date: 2024-07-25
---
...
[![Easy Installation guide](/res/easy_ins_vid.png)](https://www.youtube.com/watch?v=L1_peV8szf8)
...
Now we can configure Agent Zero - select models, settings, API Keys etc. Refer to the [Usage](/docs/usage#agent-configuration) guide for a full guide on how to configure Agent Zero.
...
If you encounter any issues during the installation process, please consult the [Troubleshooting section](/docs/troubleshooting) of this documentation or refer to the Agent Zero [Skool](https://www.skool.com/agent-zero) or [Discord](https://discord.gg/Z2tun2N3) community for assistance. 